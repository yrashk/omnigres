if(NOT DEFINED SWIPL)
    CPMAddPackage(NAME swiprolog GITHUB_REPOSITORY SWI-Prolog/swipl-devel VERSION 9.1.15 GIT_TAG V9.1.15
            DOWNLOAD_ONLY YES
    ...
    if(swiprolog_ADDED)
        execute_process(COMMAND cmake -S ${swiprolog_SOURCE_DIR} -DSWIPL_STATIC_LIB=ON
                -DSWIPL_PACKAGE_LIST=utf8proc\;http\;clib\;readline\;cpp
