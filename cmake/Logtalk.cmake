function(find_logtalk LOGTALK_VAR SWIPL_VERSION)
    ...
    if(NOT LOGTALK_VERSION)
        # FIXME: We're temporarily using an unreleased version because it fixes a few  JSON-related problems.
        # This can be switched to 3.74.0 when it is released.
        set(LOGTALK_VERSION 3.73.0-f873994)
        set(LOGTALK_GIT_TAG f873994)
    endif()

    if(NOT DEFINED LOGTALK_GIT_TAG)
        string(REPLACE "." "" _LOGTALK_VERSION_DOTLESS ${LOGTALK_VERSION})
        set(LOGTALK_GIT_TAG lgt${_LOGTALK_VERSION_DOTLESS})
    endif()
