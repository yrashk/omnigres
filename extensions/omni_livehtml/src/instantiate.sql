create function instantiate(schema regnamespace default 'omni_livehtml') returns void
    language plpgsql
as
$instantiate$
declare
...
begin
    ...
    create function html_document_text(html_document)
        returns text
    as
    'MODULE_PATHNAME',
    'html_document_text'
    ...
    /*
        ...
        'html_elements_by_tag_name_doc'
            language c immutable
                       strict;
    */
    create function render(html_document) returns html_document
    as
    'MODULE_PATHNAME'
        language c
        strict;
