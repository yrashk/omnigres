// Here until https://github.com/charmbracelet/bubbles/pull/386 is merged
package progress
...
// IsAnimating returns false if the progress bar has reached equilibrium and is no longer animating
